...
<p>But the dumped Python dict is just simple, and you can easily copy it and dump it in a Python shell.\n</p>\
<p>After a long time web searching, I finally realize what I have done.\n</p>\
...
Here is a point: <strong>Beautiful Soup \`tag.string\` returns \`NavigableString\`, not Python builti-in \`str\`.</strong>
...
<p>So we should call <code>str()</code> to convert <code>NavigableString</code> to <code>str</code>.\n</p>\
...
<p>After fixing the above mistakes, Everything works fine.\n</p>\
<h2>Additionally</h2>\
<p>\
To get current recusive depth and the limit of it, and mute the very very long recusive error traceback info, I have searched the web, finding them on Stack Overflow.
Here are them:
